...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.twitter.key = "h18mqPUlfvgJe59qXu4Mw"
   config.twitter.secret = "KbSdDaarKmPMROPdVBWHVrCfPoPUWYUBP6uwpLmZE"
   config.twitter.callback_url = "http://127.0.0.1:3000/oauth/callback?provider=twitter"
   config.twitter.user_info_mapping = {:username => "badboyPeru"}
  #
  # config.facebook.key = ""
