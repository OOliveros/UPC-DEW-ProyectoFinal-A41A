...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { dateconcert: @concert.dateconcert, group: @concert.group, hourend: @concert.hourend, hourstart: @concert.hourstart, local: @concert.local }
    end
  ...
  test "should update concert" do
    put :update, id: @concert, concert: { dateconcert: @concert.dateconcert, group: @concert.group, hourend: @concert.hourend, hourstart: @concert.hourstart, local: @concert.local }
    assert_redirected_to concert_path(assigns(:concert))
  end
